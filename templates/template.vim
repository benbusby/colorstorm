...
"\n, \0, %d, %s, etc...
hi Special       guifg=color_number    guibg=color_bg_main  gui=bold
" status line
...
hi Number        guifg=color_number    guibg=color_bg_main  gui=underline
hi Char          guifg=color_string    guibg=color_bg_main
hi String        guifg=color_string    guibg=color_bg_main  gui=italic
hi Boolean       guifg=color_boolean   guibg=color_bg_main
hi Comment       guifg=color_comment
hi Constant      guifg=color_variable                       gui=bold,underline
hi Identifier    guifg=color_type
hi Statement     guifg=color_function                       gui=none
hi CursorLine                          guibg=color_bg_alt1
hi CursorLineNR  guifg=color_function  guibg=color_bg_main  gui=bold
...
hi Type          guifg=color_type                           gui=bold
hi Underlined    guifg=color_type                           gui=underline
hi Error         guifg=#ee1111         guibg=color_bg_main
hi Todo          guifg=color_accents   guibg=color_comment  gui=none
...
hi cCustomFunc    guifg=color_function guibg=color_bg_main  gui=bold 
