...
color_table = {
  earthbound={
    ...
    color_types='#bf3000',
    color_accent='#fafd51',
    color_strings='#fb967f',
    color_numbers='#bcfaaa',
    color_booleans='#70caff',
    color_comments='#aaaaaa',
    color_variables='#abdcdc',
    color_functions='#70caff'
  },
  moonside={
    theme_id=uuid(),
    ...
    color_types='#fd9935',
    color_accent='#fd35fa',
    color_strings='#ff6693',
    color_booleans='#f6f929',
    color_variables='#c67ff4',
    color_numbers='#aaef64',
    color_comments='#aaaaaa',
    color_functions='#5e9aff'
  },
  threed={
    theme_id=uuid(),
    ...
    color_types='#ffcfcb',
    color_accent='#d4cbff',
    color_strings='#c67ff4',
    color_booleans='#ffcf32',
    color_variables='#2fff89',
    color_numbers='#d4cbff',
    color_comments='#aaaaaa',
    color_functions='#f89070'
  },
  fire_spring={
    theme_id=uuid(),
    ...
    color_types='#e5caff',
    color_accent='#74e4f3',
    color_strings='#d9c400',
    color_booleans='#ff7e50',
    color_variables='#f0e500',
    color_numbers='#a99ade',
    color_comments='#aaaaaa',
    color_functions='#d992ff'
  },
  dusty_dunes={
    theme_id=uuid(),
    ...
    color_types='#e0c364',
    color_accent='#f6d56a',
    color_strings='#ffebae',
    color_booleans='#ffd03c',
    color_variables='#f6d56a',
    color_numbers='#f6d56a',
    color_comments='#666644',
    color_functions='#f6d56a'
  },
  magicant={
    theme_id=uuid(),
    ...
    color_types='#881200',
    color_accent='#604633',
    color_strings='#7100b1',
    color_booleans='#a31100',
    color_variables='#87000d',
    color_numbers='#604633',
    color_comments='#888888',
    color_functions='#9d02f2'
  },
  cave_of_the_past={
    theme_id=uuid(),
    ...
    color_types='#3e5f39',
    color_accent='#0e1e0e',
    color_strings='#2b342a',
    color_booleans='#293d29',
    color_variables='#2b342a',
    color_numbers='#445046',
    color_comments='#93a096',
    color_functions='#0e1e0e'
  }
}
