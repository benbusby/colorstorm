...
hi Cursor	guifg=#080808 guibg=#fafd51
hi lCursor	guifg=#080808 guibg=#fafd51
hi CursorLine	guibg=#080808 gui=underline
hi CursorIM	guifg=#080808 guibg=#fafd51
hi Directory	guifg=#fafd51 guibg=#080808 gui=bold
...
"\n, \0, %d, %s, etc...
hi Special	guifg=#ffd69b guibg=#080808 gui=bold
" status line
...
hi Title	guifg=#fafd51 guibg=#080808 gui=bold
hi Visual	guifg=#fafd51 guibg=#448844 gui=none
hi VisualNOS	guifg=#cccccc guibg=#080808
hi WarningMsg	guifg=#fafd51 guibg=#080808
hi WildMenu	guifg=#3a553a guibg=#fafd51
hi Number	guifg=#25ff81 guibg=#080808 gui=underline
hi Char		guifg=#fafd51 guibg=#080808
hi String	guifg=#fb967f guibg=#080808 gui=italic
hi Boolean	guifg=#fafd51 guibg=#080808
...
hi cCustomFunc guifg=#70caff guibg=#080808 gui=bold "hi def cCustomFunc link cCustomFunc  Function
